            ...
            function init_metabox()
            {
                ...
                $this->metabox[] = [
                    ...
                    'fields'   => [
                        ...
                        [
                            'label'    => __( 'Group price', ST_TEXTDOMAIN ),
                            'id'       => 'group_price',
                            'type'     => 'list-item',
                            'settings' => [
                                [
                                ...
                                [
                                    ...
                                    'type'  => 'text',
                                    'std'   => '',
                                    'label' => __( 'Min size of group', ST_TEXTDOMAIN ),
                                ],
                                [
                                    'id'    => 'group_size_max',
                                    'type'  => 'text',
                                    'std'   => '',
                                    'label' => __( 'Max size of group', ST_TEXTDOMAIN ),
                                ],
                                [
                                    'id'    => 'group_price',
                                    'type'  => 'text',
                        ...
                        [
                            ...
                            'id'        => 'adult_age_range',
                            'type'      => 'text',
                            'desc'      => __( 'Set minimum age to consider adult. Eg 18 +', ST_TEXTDOMAIN ),
                            'std'       => 0,
                        ...
                        [
                            'label'     => __( 'Child age range', ST_TEXTDOMAIN ),
                            'id'        => 'child_age_range',
                            'type'      => 'text',
                            'desc'      => __( 'Set minimum age to consider a child. Eg 3 +', ST_TEXTDOMAIN ),
                            'std'       => 0,

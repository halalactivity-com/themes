                    ...
                    <div class="col-lg-12">
                        ...
                        <?php
                            ...
                            $args = array( 
                              ...
                              'post_status'     => 'publish',
                              'post_type'       => 'st_activity', // or 'post', 'page'
                              'orderby'         => 'post_modified', // or 'date', 'rand'
                              'order'       => 'ASC', // or 'DESC'
                            ...
                            foreach ($myposts as $key => $mypost) {
                                $post_id = $mypost->ID;
                                if( (float)explode("$", STActivity::inst()->get_price_html($post_id) )[1] > (float)$max_price ){
                                    $max_price = explode("$", STActivity::inst()->get_price_html($post_id) )[1];
                                }
                            }
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="advance-item facilities st-icheck">
                            ...
                            if(!empty($tax)){
                                ...
                                if(isset($tax['attractions'])){

                                    if(!empty($tax['attractions'])){

                                        $temp_facilities = $tax['attractions'];

                                        $in_facilities = explode(',', $tax['attractions']);
                            ...
                            <div class="item-title">
                                ...
                                <h4>
                                    ...
                                    $taxObj = get_taxonomy('attractions');
                                                ...
                                                foreach ( $facilities as $term ) {
                                                    ...
                                                    <div class="<?php echo $position == 'sidebar' ? 'col-lg-12' : 'col-lg-4 col-md-6 col-sm-6'; ?>">
                                                        ...
                                                        <div class="st-icheck-item">
                                                            ...
                                                            <label>
                                                                <?php echo $term->name; ?>
                                                                <input type="checkbox" name="" value="<?php echo $term->term_id; ?>" <?php echo in_array($term->term_id, $in_facilities) ? 'checked' : ''; ?>>
                            ...
                            <input type="hidden" class="data_taxonomy" name="taxonomy[attractions]" value="<?php echo $temp_facilities; ?>">

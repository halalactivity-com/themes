...
<div class="form-group" style="display: none;">
    <div class="max-notice-wrapper">
        <p style="font-size: 13px; color: #5E6D77;">Only <b><?php echo $max_people; ?></b> <?php if ($max_people>1) {
    echo "vacancies";
} else {
    echo "vacany";
} ?> is available for this activity</p>
    </div>
</div>
                ...
                if ($max_item <= 0) {
                    $max_item = 1;
                            ...
                            <select class="form-control app extra-service-select"
                                    ...
                                    data-extra-price="<?php echo TravelHelper::convert_money($val[ 'extra_price' ]); ?>">

<?php
    ...
    while (have_posts()): the_post();
        ...
        ?>
        <div id="st-content-wrapper" class="st-single-tour style-2 test">
            ...
            <div class="st-tour-content">
                <div class="container">
                            ...
                            <div class="st-hotel-header">
                                <div class="left">
                                    ...
                                    <div class="sub-heading">
                                        <?php if ($address) {
                    echo TravelHelper::getNewIcon('ico_maps_add_2', '#29abe2', '16px', '16px');
                    echo esc_html($address);
                }
                                        ?>
                                        <a href="" class="st-link font-medium" data-toggle="modal" data-target="#st-modal-show-map"> <?php echo esc_html__('View on map', ST_TEXTDOMAIN) ?></a>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="st-map">
                                                            <div class="google-map" data-lat="<?php echo trim($lat) ?>"
                                                                 ...
                                                                 data-showcustomcontrol="false"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <?php
                                if (!empty($gallery_array)) { ?>
                                    <div class="st-gallery" data-width="100%"
                                        ...
                                        <div class="shares dropdown">
                                            ...
                                            <ul class="share-wrapper">
                                                ...
                                                <!-- <li><a class="instagram"
                                                       href="https://instagram.com/share?url=<?php //the_permalink()?>&amp;title=<?php // the_title()?>"
                                                       target="_blank" rel="noopener" original-title="Instagram"><i
                                                                class="fa fa-instagram fa-lg"></i></a></li> -->
                                                <li><a class="whatsapp"
                                                       href="whatsapp://send?text=<?php the_permalink() ?>&amp;title=<?php the_title() ?>"
                                        ...
                                        <div class="btn-group play-video">
                            ...
                            <div class="st-tour-feature">
                                <div class="row">
                                    <div class="col-xs-6 col-lg-3">
                                        <div class="item">
                                            <div class="icon">
                                                <?php echo TravelHelper::getNewIcon('ico_clock', '#29abe2', '32px', '32px'); ?>
                                            </div>
                                            <div class="info">
                                    ...
                                    <div class="col-xs-6 col-lg-3">
                                        <div class="item">
                                            <div class="icon">
                                                <?php echo TravelHelper::getNewIcon('ico_adults_blue', '#29abe2', '32px', '32px'); ?>
                                            </div>
                                            <div class="info">
                                                <h4 class="name"><?php echo __('Capacity', ST_TEXTDOMAIN); ?></h4>
                                                <p class="value">
                                                    <?php
                                                        ...
                                                        if (empty($max_people) or $max_people == 0 or $max_people < 0) {
                                                            ...
                                                            if ($max_people == 1 && $min_people == 1) {
                                                                ...
                                                                if ($min_people > $max_people) {
                                                                    echo "Error. Min greater than Max.";
                                                                } else {
                                                                    echo sprintf(__('%s - %s people', ST_TEXTDOMAIN), $min_people, $max_people);
                                                                }
                                                            }
                                                        }
                                                    ?>
                                    ...
                                    <div class="col-xs-6 col-lg-3">
                                        <div class="item">
                                            <div class="icon">
                                                <?php echo TravelHelper::getNewIcon('money-wallet', '#29abe2', '32px', '32px'); ?>
                                                <!-- <img src="https://www.halalactivities.com/wp-content/uploads/2019/08/wallet-1.svg" alt="Deposit icon" width="32px" height="32px" > -->
                                            </div>
                                            <div class="info">
                                                <h4 class="name"><?php echo __('Deposit', ST_TEXTDOMAIN); ?></h4>
                                                <p class="value">
                                                    100% in Advance
                                                    <?php
                                                        // $deposit_status = get_post_meta( get_the_ID(), 'deposit_payment_status', true );
                                                        // if ( empty( $deposit_status ) ) {
                                                        //     echo __( 'Not Required', ST_TEXTDOMAIN );
                                                        // } else {
                                                        //     $deposit_payment_amount = get_post_meta( get_the_ID(), 'deposit_payment_amount', true );
                                                        //     echo $deposit_payment_amount."%";
                                                        // }
                                                    ?>
                                                </p>
                                            </div>
                                    ...
                                    <div class="col-xs-6 col-lg-3">
                                        <div class="item">
                                            <div class="icon">
                                                <?php echo TravelHelper::getNewIcon('Group', '#29abe2', '32px', '32px'); ?>
                                            </div>
                                            <div class="info">
                            ...
                            <!-- <div class="test"><?php // echo "lat: $lat, lang: $lng";?>
                                <img src="https://maps.googleapis.com/maps/api/staticmap?center=<?php // echo $lat;?>,<?php // echo $lng;?>&zoom=<?php // echo $zoom;?>&size=400x400&key=AIzaSyDTialfsmenPmcL5MsWHjTNhGHftY_E_Yo" alt="test">
                            </div> -->
                            <div class="st-include">
                                <h3 class="st-section-title">
                                    <?php echo __('Included/Excluded', ST_TEXTDOMAIN); ?>
                                </h3>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <ul class="include">
                            ...
                            <!-- Tour Refund Policy -->
                            <?php
                                if (!empty(get_the_terms($post_id, 'refund-policy'))) {
                                    $terms = get_the_terms($post_id, 'refund-policy'); ?>
                            <div class="st-refund-policy">
                                <h3 class="st-section-title" style="margin-bottom: 30px;">
                                    Refund Policy
                                </h3>
                                <div class="row">
                                    <div class="col-xs-12 refund-policy-wrapper">
                                        <?php foreach ($terms as $key => $value) { ?>
                                        <p style="color: #768090; font-size: 14px;"><?php echo $value->name; ?></p>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Tour Restrictions -->
                            <?php
                                if (!empty(get_the_terms($post_id, 'restrictions'))) {
                                    $terms = get_the_terms($post_id, 'restrictions'); ?>
                            <div class="st-restrictions">
                                <h3 class="st-section-title" style="margin-bottom: 30px;">
                                    Restrictions
                                </h3>
                                <div class="row">
                                    <div class="col-xs-12 restrictions-wrapper">
                                        <?php foreach ($terms as $key => $value) { ?>
                                        <p style="color: #768090; font-size: 14px;"><?php echo $value->name; ?></p>
                                        <?php } ?>
                                    </div>
                            ...
                            if (!empty($tour_faq)) {
                                ...
                                foreach ($tour_faq as $k => $v) { ?>
                                    <div class="item <?php echo $i == 0 ? 'active' : ''; ?>">
                                        <div class="header">
                                            <?php echo TravelHelper::getNewIcon('question-help-message', '#29abe2', '18px', '18px'); ?>
                                        ...
                                        <div class="col-lg-7">
                                            <div class="review-sumary">
                                                <?php
                                                    ...
                                                    $stat_total = array();
                                                    // var_dump($stats);
                                                    foreach ($stats as $key => $statname) {
                                                        $meta_name = preg_replace('/\s+/', '-', strtolower($statname['title']));
                                                        $query = "SELECT sum({$wpdb->commentmeta}.meta_value) as total from {$wpdb->comments} join {$wpdb->commentmeta} on {$wpdb->comments}.comment_ID={$wpdb->commentmeta}.comment_ID where 1=1 and comment_post_ID = '$post_id' and comment_approved = 1 and meta_key = 'st_stat_".$meta_name."'";
                                                        $count = $wpdb->get_var($query);
                                                        $stat_total[$meta_name] = ($total == 0) ? 0 : round($count/$total, 0);
                                                    }
                                                ?>
                                                <?php $rate_exe = STReview::count_review_by_rate(null, 5); ?>
                                                <div class="item">
                                                    <div class="label">
                                                        <?php echo esc_html__('Value for money', ST_TEXTDOMAIN) ?>
                                                    </div>
                                                    <div class="progress">
                                                        <div class="percent green"
                                                             style="width: <?php echo TravelHelper::cal_rate($stat_total['value-for-money'], 5) ?>%;"></div>
                                                    </div>
                                                    <div class="number" style='display: none;'><?php echo $stat_total['value-for-money']; ?></div>
                                                </div>
                                                <?php $rate_good = STReview::count_review_by_rate(null, 4); ?>
                                                <div class="item">
                                                    <div class="label">
                                                        <?php echo __('Customer Service', ST_TEXTDOMAIN) ?>
                                                    </div>
                                                    <div class="progress">
                                                        <div class="percent green"
                                                             style="width: <?php echo TravelHelper::cal_rate($stat_total['customer-service'], 5) ?>%;"></div>
                                                    </div>
                                                    <div class="number" style='display: none;'><?php echo $stat_total['customer-service']; ?></div>
                                                </div>
                                                <?php $rate_avg = STReview::count_review_by_rate(null, 3); ?>
                                                <div class="item">
                                                    <div class="label">
                                                        <?php echo __('Experience', ST_TEXTDOMAIN) ?>
                                                    </div>
                                                    <div class="progress">
                                                        <div class="percent green"
                                                             style="width: <?php echo TravelHelper::cal_rate($stat_total['experience'], 5) ?>%;"></div>
                                                    </div>
                                                    <div class="number" style='display: none;'><?php echo $stat_total['experience']; ?></div>
                                                </div>
                                                <?php $rate_poor = STReview::count_review_by_rate(null, 2); ?>
                                                <div class="item">
                                                    <div class="label">
                                                        <?php echo __('Environment', ST_TEXTDOMAIN) ?>
                                                    </div>
                                                    <div class="progress">
                                                        <div class="percent green"
                                                             style="width: <?php echo TravelHelper::cal_rate($stat_total['environment'], 5) ?>%;"></div>
                                                    </div>
                                                    <div class="number" style='display: none;'><?php echo $stat_total['environment']; ?></div>
                                                </div>
                                                <?php $rate_terible = STReview::count_review_by_rate(null, 1); ?>
                                                <div class="item">
                                                    <div class="label">
                                                        <?php echo __('Family Friendliness', ST_TEXTDOMAIN) ?>
                                                    </div>
                                                    <div class="progress">
                                                        <div class="percent green"
                                                             style="width: <?php echo TravelHelper::cal_rate($stat_total['family-friendliness'], 5) ?>%;"></div>
                                                    </div>
                                                    <div class="number" style='display: none;'><?php echo $stat_total['family-friendliness']; ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-3">
                            ...
                            <div class="widgets">
                                <div class="fixed-on-mobile" id="booking-request" data-screen="992px">
                                        ...
                                        <div class="form-book-wrapper relative">
                                            ...
                                            <div class="form-head">
                                                ...
                                                <span class="label">
                                                    ...
                                                    <span class="value" data-symbol='<?php echo TravelHelper::just_symbol()["symbol"]; ?>' data-template = '<?php echo TravelHelper::just_symbol()["template"]; ?>'>
                                                    <?php
                                                    if (STTour::get_price_type($post_id) == 'fixed') {
                                                        ...
                                                        if ($result->total == 0) {
                                                            $group_price = json_encode(get_post_meta($post_id, 'group_price', true));
                                                            $grp_obj = json_decode($group_price);
                                                            $init_base_price = TravelHelper::format_money($grp_obj[0]->group_price);
                                                            foreach ($grp_obj as $grpKey => $grp) {
                                                            ...
                                                            $group_price = json_encode($grp_obj);
                                                        } else {
                                                            $group_price  = stripslashes($result->price);
                                                            $grp_obj = json_decode($group_price, true);
                                                            $grp_keys = array_keys($grp_obj);
                                                            $init_base_price = TravelHelper::format_money($grp_obj[$grp_keys[0]]['grp_price']);
                                                        } ?>
                                                    <span data-grp-prices='<?php echo $group_price; ?>' class="text-lg lh1em item "><?php echo $init_base_price; ?></span>
                                                    <?php
                                                    } else {
                                                ...
                                                <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                                    <div class="tab-pane fade in active" id="nav-book" role="tabpanel" aria-labelledby="nav-book-tab">
                                                        <form id="form-booking-inpage" method="post" action="#booking-request" class="activity-booking-form">
                                                            ...
                                                            $start = date(TravelHelper::getDateFormat(), strtotime("+ 2 day"));
                                                            $end = date(TravelHelper::getDateFormat(), strtotime("+ 2 day"));
                                                            $date = date(TravelHelper::getDateFormat(), strtotime("+ 2 day")). '-'. date(TravelHelper::getDateFormat(), strtotime("+ 2 day"));
                                                            ...
                                                            <div class="form-group">
                                                                <div class="grp-total price-total">
                                                                    <span class="adult-total">
                                                                        <table>
                                                                            <tr>
                                                                                <td><p class="text"></p></td>
                                                                                <td><p class="price" style="text-align: center;"></p></td>
                                                                            </tr>
                                                                        </table>
                                                                    </span>
                                                                    ...
                                                                    <span class="final-total">
                                                                        <table>
                                                                            <tr>
                                                                                <th><p class="text"></p></th>
                                                                                <th><p class="price" style="text-align: center;"></p></th>
                                                                            </tr>
                                                                        </table>
                                                                    </span>
                                                                </div>
                                            ...
                                            <?php } else { ?>
                                                <div class="submit-group mb30">
                                                    <a href="<?php echo esc_url($activity_external_link); ?>" target="_blank" class="btn btn-green btn-large btn-full upper"><?php echo esc_html__('Book Now', ST_TEXTDOMAIN); ?></a>
                                                </div>
                                            <?php } ?>
                                        </div>
                                        <?php
                                                ...
                                                <span class="value" data-symbol='<?php echo TravelHelper::just_symbol()["symbol"]; ?>' data-template = '<?php echo TravelHelper::just_symbol()["template"]; ?>'>
                                                    ...
                                                    if (STTour::get_price_type($post_id) == 'fixed') {
                                                        ...
                                                        if ($result->total == 0) {
                                                            ...
                                                            $group_price  = stripslashes($result->price);
                                                            $grp_obj = json_decode($group_price, true);
                                                            foreach ($grp_obj as $key => $value) {
                                                                $grp_obj[$key]['grp_price'] = TravelHelper::just_money($value);
                                                            }
                                                            $group_price = json_encode($grp_obj);
                                                            $grp_keys = array_keys($grp_obj);
                                                            $init_base_price = TravelHelper::format_money($grp_obj[$grp_keys[0]]['grp_price']);
                                    ...
                                    ?>
                                    <div class="cancellation-box widget-box">
                                        <h4 class="heading"><?php echo __('Cancellation Policy', ST_TEXTDOMAIN) ?></h4>
                                        <div class="media">
                                            <div class="cancellation-info">
                                                <h5><span style="font-weight: 600; color: #39B54A;">Refundable:</span> Up to 7 Days</h5>
                                                <h5><span style="font-weight: 600; color: #F7931E;">Partial Refund:</span> Up to 4 Days(70%)</h5>
                                                <h5><span style="font-weight: 600; color: #C1272D;">Non-Refundable:</span> Less than 24 hrs</p>
                                                <h5>                                                    
                                                    <?php
                                    ...
                                    <div id="tag_cloud-2" class="sidebar-widget widget_tag_cloud">
                                        ...
                                        <div class="tagcloud">
                                            <?php
                                                $tags = get_the_terms($post_id, 'attractions');
                                                if (!empty($tags)) {
                                                    foreach ($tags as $key => $tag) {
                                                        ?>
                                            <a target="_blank" href="/activities/?taxonomy%5Battractions%5D=<?php echo $tag->term_id; ?>" class="tag-cloud-link tag-link-103 tag-link-position-2" style="font-size: 22pt; color: #1A2B48 !important;" aria-label="<?php echo $tag->name; ?>"><?php echo $tag->name; ?></a>
                                            <?php
                                                    }
                                                }
                                            ?>
                    ...
                    <?php
                        ...
                        $city_filter = explode(' ', $address);
                        // echo '<pre>' . var_export($city_filter, true) . '</pre>';
                        $city_filter2 = explode('/', $city_filter[1]);
                        // echo '<pre>' . var_export($city_filter2, true) . '</pre>';
                        $args = [
                            'posts_per_page' => -1,
                            ...
                            'meta_query' => array(
                                ...
                                array(
                                    'key' => 'address',
                                    'compare' => 'LIKE',
                                    'value' => $city_filter2[0]
                                ),
                                // array(
                                //     'key' => 'address',
                                //     'compare' => 'LIKE',
                                //     'value' => $city_filter2[1]
                                // )
                            )
                        ];
                        global $post;
                        ...
                        if ($query->have_posts()):
                            ...
                            <div class="st-list-tour-related row mt50">
                                <?php
                                    ...
                                    // $post_meta = get_post_meta(12478);
                                    // echo '<pre>' . var_export($post_meta, true) . '</pre>';
                                    while ($query->have_posts()): $query->the_post();
                                        $info_price = STActivity::inst()->get_info_price();
                                        $url=st_get_link_with_search(get_permalink(), array('start'), $_GET);
                                        $relatedPostAddress = get_post_meta(get_the_ID(), 'address', true);
                                        // echo "Address: $address; RelatedAdress: $relatedPostAddress";
                                        // echo "this " . strcasecmp( $address,$relatedPostAddress );
                                        
                                        if ($post_id == get_the_ID() || $counter >= 4) {
                                            // if ($post_id == get_the_ID() || strcasecmp($address, $relatedPostAddress) != 0 || $counter >= 4) {
                                            continue;
                                        } else {
                                            $counter++;
                                        }
                                                    ...
                                                    <div class="section-footer">
                                                        <div class="footer-inner plr15">
                                                            <div class="service-price">
                                                                ...
                                                                <span class="price">
                                                                    <?php
                                                                        if (STTour::get_price_type(get_the_ID()) == 'fixed') {
                                                                            $grpPrice = get_post_meta(get_the_ID(), 'group_price', true);
                                                                            echo TravelHelper::format_money($grpPrice[0]['group_price']);
                                                                        } else {
                                                                            echo STActivity::inst()->get_price_html(get_the_ID());
                                                                        }
                                                                    ?>

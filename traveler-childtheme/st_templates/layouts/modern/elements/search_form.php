...
if (!empty($service)) {
    ...
    if (is_array($service)) {
        ...
        foreach ($service as $tab) {
            ...
            $classForm .= 'st-search-form-' . $tab['tab_service'] . " "; // File Edit - Added space after class - 5/10/19

        }

    } else {

        $classForm = 'st-search-form-' . $service . " "; // File Edit - Added space after class - 5/10/19

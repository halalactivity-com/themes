	...
	<div class="col-lg-4 col-md-4 col-lg-push-8 col-md-push-8">
		...
		<div class="cart-info">
			...
			<div class="total-section">
                ...
                $price_type = STTour::get_price_type($key);
                $adult_number = get_post_meta($order_code, 'adult_number', true);
                $child_number = get_post_meta($order_code, 'child_number', true);
                $infant_number = get_post_meta($order_code, 'infant_number', true);
                ...
                if($price_type == 'person' or $price_type == 'fixed_depart'){
                    ...
                    $data_price['adult_price'] = get_post_meta($order_code, 'adult_price', true) * $adult_number;

                    $data_price['child_price'] = get_post_meta($order_code, 'child_price', true) * $child_number;

                    $data_price['infant_price'] = get_post_meta($order_code, 'infant_price', true) * $infant_number;
                
                    $origin_price = get_post_meta($order_code, 'ori_price', true);//isset($data_price['origin_price']) ? $data_price['origin_price'] : 0;
                }
                else{
                    $group_price  = get_post_meta( $key, 'group_price', true );
                    ...
                    $data_price['total_price'] = $base_price;

                ...
                <div class="row">
                        ...
                        <div class="cart-info" id="cart-info">
                            ...
                            if ( !empty( $all_items ) and is_array( $all_items ) ) {
                                ...
                                foreach ( $all_items as $key => $value ) {
                                    $id = $value['data']['st_booking_id'];

                                    do_action('st_cart_item_html_' . $id);

                                    if ( $id == 'car_transfer' ) {

                                        $transfer = new STCarTransfer();

                                        echo balanceTags( $transfer->get_cart_item_html( $id ) );
                                            ...
                                            switch ( $post_type ) {
                                                ...
                                                case "st_flight":
                                                    ...
                                                    if ( class_exists( 'ST_Flight_Checkout' ) ) {
                                                        ...
                                                        echo ST_Flight_Checkout::inst()->get_cart_item_html( $id );
                                                ...
                                                case "car_transfer":
                                                    ...
                                                    if ( class_exists( 'STCarTransfer' ) ) {
                                                        ...
                                                        echo STCarTransfer::inst()->get_cart_item_html( $id );
                    ...
                    <div class="col-lg-8 col-md-8 col-lg-pull-4 col-md-pull-4">
                        ...
                        <h3 class="title">
                            ...
                            <?php echo __('Your Details', ST_TEXTDOMAIN); ?>

				...
				<ul class="author-review-panel">
					...
					foreach ($arr_service as $k => $v) {
						...
						if (STUser_f::_check_service_available_partner($v, $current_user_upage->ID)) {
							...
							<li class="<?php echo $post_type_service == $v ? 'active' : ''; ?>">
										...
										foreach ($avrage as $k => $v) {
											...
											<div class="col-sm-6">
												...
												<div class="stm-dealer-rate-part stm-dealer-rate-part-1">
													...
													<!-- Review Layout Update - start - 7/10/19 -->

													<!-- <table>
														<tr>
															<td><h4><?php //echo esc_html($k); ?></h4></td>
															<td> <div class="process"><div class="inner" style="width: <?php //echo esc_attr($v)/5 * 100; ?>%"></div></div></td>
															<td><div class="statistic"><?php// echo esc_html($v); ?>/5</div></td>
														</tr>
													</table>
 -->
													<!-- End -->

...
if (!empty($arr_service)) { ?>
    ...
    <ul class="nav nav-tabs" id="">
        ...
        // Chagne Start. Remove rest of the modules and only keep Activity. 1/10/2019

        unset($arr_service);

        $arr_service[0] = 'activity';

        $active_tab = $arr_service[0];
        ...
        foreach ($arr_service as $k => $v) {
            ...
            if (STUser_f::_check_service_available_partner('st_'.$v, $current_user_upage->ID)) {
                ...
                <li class="<?php echo $active_tab == $v ? 'active' : ''; ?>"><a href="<?php echo $url; ?>" aria-expanded="true">
                    <?php
    ...
    <div class="st-review-new">
        ...
        <h5><?php echo __('Reviews', ST_TEXTDOMAIN); ?></h5>

        ...
        <div class="infor-st-setting">
            ...
            <form method="post" action="" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <label for="st_paypal_email"><?php //esc_html_e("Paypal Email",ST_TEXTDOMAIN) 
                                                    ?></label>

                    <input name="st_paypal_email" class="form-control" value="<?php //echo get_user_meta($data->ID , 'st_paypal_email' , true) 
                                                                                ?>" type="text" />

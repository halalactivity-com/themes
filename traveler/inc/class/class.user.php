            ...
            if (!empty($pageposts)) {
                foreach ($pageposts as $key => $value) {
                    ...
                    if (STReview::review_check($id_item) == 'true') {
                        $action = '<a style="display:none;" class="btn btn-xs btn-primary" class="user_write_review" href="' . st_get_link_with_search(get_permalink($user_url), [
                                'sc',
                                'item_id'
        ...
        */
        ...
        public function check_partner_can_set_external_link($fields) {
            ...
            if ( st()->get_option( 'partner_set_external_link', 'off' ) == 'off') {
                ...
                // for car
                if (!empty($sc) && ( $sc == 'create-cars' || $sc == 'edit-cars' ) ) {

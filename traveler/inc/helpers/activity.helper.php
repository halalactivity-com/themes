...

        {
...

	        {
		        ...
		        $data = ST_Activity_Availability::inst()
			        ...
			        // ->where("CASE WHEN check_in = check_out THEN check_in BETWEEN {$check_in} AND {$check_out} ELSE {$check_in} >= check_in AND ({$check_out} >= check_in AND {$check_out} <= check_out) END", null, true)

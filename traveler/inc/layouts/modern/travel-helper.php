...
if (!class_exists('TravelHelper')) {
    class TravelHelper
    {
         ...
         *
         * */
        static function just_money($money = false, $need_convert = true, $precision = 0)
        {
            $money = (float)$money;
            ...
            <div id="respond" class="comment-respond" data-toggle-section="st-review-form"
                ...
                //do_action( 'comment_form_must_log_in_after' );
                    ...
                    <form action="<?php echo esc_url($args['action']); ?>" method="post"
                        ...
                        if (get_post_type($post_id) != 'st_activity' && get_post_type($post_id) != 'st_tours') {
                        ?>

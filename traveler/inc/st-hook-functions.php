...
//            wp_enqueue_script( 'custom.js', get_template_directory_uri() . '/js/custom.js', [ 'jquery' ], null, true );
        ...
        if (is_page_template('template-user.php')) {
            ...
            if($check_enable_map_google === 'on'){
                ...
                wp_register_script('mapboxv5', 'https://api.tiles.mapbox.com/mapbox-gl-js/v1.0.0/mapbox-gl.js',array(),true,false);
        ...
        if($check_enable_map_google === 'on'){
            ...
            wp_enqueue_script('mapbox-js', 'https://api.tiles.mapbox.com/mapbox-gl-js/v1.0.0/mapbox-gl.js', ['jquery'], null, false);

            wp_enqueue_style('mapbox-css', 'https://api.tiles.mapbox.com/mapbox-gl-js/v1.0.0/mapbox-gl.css');
...
function st_send_email_single_service(){
    ...
    $subject_st = "We received your enquiry";//$name_st.' - '.$email_st;
    ...
    if(empty($name_st) || (empty($email_st)) || (empty($phone_st))  || (empty($content_st))){
        ...
        $body_email = "<html><head><meta http-equiv='Content-Type' content='text/html;'/><title>" . get_bloginfo( 'name', 'display' ) . " </title></head><body marginwidth='0' topmargin='0' marginheight='0' offset='0'><div id='wrapper'><table border='0' cellpadding='0' cellspacing='0' height='100%' width='100%'><tr><td align='center' valign='top'><table border='0' cellpadding='0' cellspacing='0' width='600' id='template_container' style='border: 1px solid #cccccc;'><tr><td align='center' valign='top'><table border='0' cellpadding='0' cellspacing='0' width='600' id='template_header'><tr><td id='header_wrapper'><p style='margin-top:0;''><a target='_blank' href='https://halalactivities.com'><img style='width: 600px;'' src=". esc_url( $img ) ." alt='".get_bloginfo( 'name', 'display' )."'/></a></p></td></tr></table></td></tr><tr><td align='center' valign='top'><table border='0' cellpadding='0' cellspacing='0' width='600' id='template_body' style='width: 100%;'><tr><td valign='top' id='body_content'><table border='0' cellpadding='20' cellspacing='0' width='100%'><tr><td valign='top' style='padding:0;'><div id='body_content_inner' style='padding: 10px;'><p>Greetings from HalalActivities.com,</p><p>This is an automated reply to your form submission. Please do NOT reply to this email.</p><p>Thank you for reaching to us. We will contact you within the next 12 hours regarding your enquiry.</p><p>Your message:</p><br/><strong>" . __('Type Service',ST_TEXTDOMAIN)."</strong>: ".$type_service."<br/>". "<strong>". __('Name Service',ST_TEXTDOMAIN)."</strong>: ".$name_service."<br/>". "<strong>".__('Name customer',ST_TEXTDOMAIN)."</strong>: ".$name_st."<br/>". "<strong>".__('Email customer',ST_TEXTDOMAIN)."</strong>: ".$email_st."<br/>". "<strong>".__('Phone customer',ST_TEXTDOMAIN)."</strong>: ".$phone_st."<br/>". "<strong>".__('Note',ST_TEXTDOMAIN)."</strong>: ".$content_st."<br/></div></td></tr></table></td></tr></table></td></tr><tr><td align='center' valign='top'><table style='width: 100%;' border='0' cellpadding='10' cellspacing='0' width='600' id='template_footer'><tr><td valign='top' style='padding: 0 !important;'><table border='0' cellpadding='10' cellspacing='0' width='100%'><tr><td colspan='2' valign='middle' id='credit' style='padding: 0 !important;'>" . wpautop( wp_kses_post( wptexturize( apply_filters( 'woocommerce_email_footer_text', get_option( 'woocommerce_email_footer_text' ) ) ) ) ) . "</td></tr></table></td></tr></table></td></tr></table></td></tr></table><div class='auto_msg'><p style='text-align: center;'>This is an automatically generated message, please do not reply.</p><p style='text-align: center;'>If you have any queries regarding your booking, please contact us <a href='mailto:bookings@halalactivities.com'>here</a>.</p><p style='text-align: center;'>For more information, check our <a href='https://www.halalactivities.com/'>website</a>.</p></div></div></body>";

        // $other_email = $theme_option['email_admin_address'];

        $multiple_to_recipients = array($email_st);//$email_st,$admin_email);
        ...
        $body_email = "<html><head> <meta http-equiv='Content-Type' content='text/html;'/> <title>" . get_bloginfo( 'name', 'display' ) . " </title></head><body marginwidth='0' topmargin='0' marginheight='0' offset='0'> <div id='wrapper'> <table border='0' cellpadding='0' cellspacing='0' height='100%' width='100%'> <tr> <td align='center' valign='top'> <table border='0' cellpadding='0' cellspacing='0' width='600' id='template_container' style='border: 1px solid #cccccc;'> <tr> <td align='center' valign='top'> <table border='0' cellpadding='0' cellspacing='0' width='600' id='template_header'> <tr> <td id='header_wrapper'> <p style='margin-top:0;' '><a target='_blank ' href='https://halalactivities.com '><img style='width: 600px; '' src=". esc_url( $img ) ." alt='".get_bloginfo( ' name ', 'display ' )."'/> </a> </p></td></tr></table> </td></tr><tr> <td align='center' valign='top'> <table border='0' cellpadding='0' cellspacing='0' width='600' id='template_body' style='width: 100%;'> <tr> <td valign='top' id='body_content'> <table border='0' cellpadding='20' cellspacing='0' width='100%'> <tr> <td valign='top' style='padding:0;'> <div id='body_content_inner' style='padding: 10px;'> <p>You have received the following <b><u>Enquiry</u></b> from ".$name_st."</p><p>Details of the booking:</p><br/> <strong>" . __('Type Service',ST_TEXTDOMAIN)."</strong>: ".$type_service." <br/>". "<strong>". __('Name Service',ST_TEXTDOMAIN)."</strong>: ".$name_service." <br/>". "<strong>".__('Name customer',ST_TEXTDOMAIN)."</strong>: ".$name_st." <br/>". "<strong>".__('Email customer',ST_TEXTDOMAIN)."</strong>: ".$email_st." <br/>". "<strong>".__('Phone customer',ST_TEXTDOMAIN)."</strong>: ".$phone_st." <br/>". "<strong>".__('Note',ST_TEXTDOMAIN)."</strong>: ".$content_st." <br/> </div></td></tr></table> </td></tr></table> </td></tr><tr> <td align='center' valign='top'> <table style='width: 100%;' border='0' cellpadding='10' cellspacing='0' width='600' id='template_footer'> <tr> <td valign='top' style='padding: 0 !important;'> <table border='0' cellpadding='10' cellspacing='0' width='100%'> <tr> <td colspan='2' valign='middle' id='credit' style='padding: 0 !important;'>" . wpautop( wp_kses_post( wptexturize( apply_filters( 'woocommerce_email_footer_text', get_option( 'woocommerce_email_footer_text' ) ) ) ) ) . "</td></tr></table> </td></tr></table> </td></tr></table> </td></tr></table> <div class='auto_msg'> <p style='text-align: center;'>This is an automatically generated message, please do not reply.</p><p style='text-align: center;'>If you have any queries regarding your booking, please contact us <a href='mailto:bookings@halalactivities.com'>here</a>.</p><p style='text-align: center;'>For more information, check our <a href='https://www.halalactivities.com/'>website</a>.</p></div></div></body>";

        // $other_email = $theme_option['email_admin_address'];

        $multiple_to_recipients = array($admin_email);//$email_st,$admin_email);

        $subject = "Enquiry received on HalalActivities for activity " . $name_service;

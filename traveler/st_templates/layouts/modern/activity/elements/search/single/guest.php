...
<div class="form-group form-guest-search clearfix <?php if($has_icon) echo ' has-icon '; ?>">
    ...
    <div class="guest-wrapper clearfix">
        <div class="check-in-wrapper">
            ...
            <div class="render"><?php echo sprintf(__( '%s', ST_TEXTDOMAIN ),$activity_guest_adult); ?></div>
        </div>
    ...
    <div class="guest-wrapper clearfix">
        <div class="check-in-wrapper">
            ...
            <div class="render"> <?php echo sprintf(__( '%s', ST_TEXTDOMAIN ),$activity_guest_childrent); ?></div>
        </div>
        <div class="select-wrapper">
            <div class="st-number-wrapper">
    ...
    <div class="guest-wrapper clearfix">
        <div class="check-in-wrapper">
            ...
            <div class="render"><?php echo sprintf(__( '%s', ST_TEXTDOMAIN ),$activity_guest_infant); ?></div>
        </div>
        <div class="select-wrapper">
            <div class="st-number-wrapper">

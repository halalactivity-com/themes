        ...
        <li class="item">
            ...
            <div class="select-wrapper">
                <div class="st-number-wrapper">
                    <input type="text" name="no_rooms" value="<?php echo $room_num_search; ?>" class="form-control st-input-number" autocomplete="off" readonly data-min="1" data-max="100"/>
                </div>
            </div>
        </li>
        <li class="item">
            ...
            <div class="select-wrapper">
                <div class="st-number-wrapper">
                    <input type="text" name="group_adults" value="<?php echo $adult_number; ?>" class="form-control st-input-number" autocomplete="off" readonly data-min="1" data-max="100"/>
                </div>
            </div>
        </li>
        <li class="item">
            ...
            <div class="select-wrapper">
                <div class="st-number-wrapper">
                    <input type="text" name="group_children" value="<?php echo $child_number; ?>" class="form-control st-input-number" autocomplete="off" readonly data-min="0" data-max="100"/>
                </div>
            </div>
        </li>

...
if(!empty($pick_up_date)){
    ...
    $pick_up_datetext = TravelHelper::getDateFormatMoment();
    $pick_up_date = "";
}
...
if(!empty($drop_off_date)){
    ...
    $drop_off_datetext = TravelHelper::getDateFormatMoment();
    $drop_off_date = "";
}
?>
<div class="form-group form-extra-field form-date-field form-date-search form-date-car clearfix <?php if ($has_icon) echo ' has-icon '; ?>"
    ...
    <div class="date-wrapper clearfix">
        <div class="check-in-wrapper">
            ...
            <div class="render check-in-render"><?php echo $pick_up_datetext . ', '. $pick_up_time; ?></div>
        </div>
        <div class="check-out-wrapper">
            <label><?php echo __('Return Time', ST_TEXTDOMAIN); ?></label>
            <div class="render check-out-render"><?php echo $drop_off_datetext.', '. $drop_off_time; ?></div>
            <span>
        </div>
    </div>

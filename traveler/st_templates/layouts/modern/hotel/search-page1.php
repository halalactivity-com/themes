...
?>
    ...
    <div class="full-map">
        ...
        <div class="full-map-item">
            ...
            <div id="map-search-form" style="width: 100%; height: <?php echo $height_map;?>" class="full-map-form" data-disablecontrol="true" data-showcustomcontrol="true" data-zoom="<?php echo esc_attr($zoom_map); ?>" data-popup-position="right"></div>
        </div>

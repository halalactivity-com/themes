                                                                        ...
                                                                        <ul class="st_grid_date">
                                                                            ...
                                                                            <li>
                                                                                <div class="st-item-date">
                                                                                    ...
                                                                                    </span><div class="render check-out-render"><?php echo $end; ?></div>
                                                                                </div>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                            ...
                                            <?php
                                                ...
                                                if($enable_inbox === 'on'){ ?>
                                                    <div class="st_ask_question">
                                                        ...
                                                        <?php } else{?>
                                                            <a href="" id="btn-send-message-owner" class="btn-send-message btn btn-primary upper mt5" data-id="<?php echo get_the_ID();?>"><?php echo __('Ask a Question', ST_TEXTDOMAIN);?></a>
                                                        <?php }?>
                                                    </div>
                                            <?php }?>
                                        </div>

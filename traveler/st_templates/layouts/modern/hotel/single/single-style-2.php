                                    ...
                                    <div class="tab-pane fade in active" id="nav-book" role="tabpanel" aria-labelledby="nav-book-tab">
                                        ...
                                        <form class="form form-check-availability-hotel clearfix">
                                            ...
                                            <div class="form-group submit-group">
                                               ...
                                               <!--  <input  type="submit" class="btn btn-default btn-send-message" data-id="<?php echo get_the_ID();?>" name="st_send_message" value="<?php echo __('Send message', ST_TEXTDOMAIN);?>"> -->
                                            </div>
                                        </form>
                                    </div>

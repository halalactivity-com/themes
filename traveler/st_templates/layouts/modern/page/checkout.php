                    ...
                    <?php 
                        ...
                        <?php } else {?>
                            <div class="col-lg-12 col-md-12">
                                ...
                                <div class="check-out-form">
                                    <div class="entry-content">
                                        <a data-target="#st-login-form" data-toggle="modal" class="btn btn-green  upper" type="submit" ><?php echo __('Login', ST_TEXTDOMAIN); ?></a>
                                        <a data-target="#st-register-form" data-toggle="modal" class="btn btn-green upper" type="submit" ><?php echo __('Register', ST_TEXTDOMAIN); ?></a>
                                    </div>
                                </div>
                            </div>
                        <?php }?>

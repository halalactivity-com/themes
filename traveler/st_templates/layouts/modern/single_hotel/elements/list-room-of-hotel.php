                            ...
                            if ( $rooms['data']->have_posts() ) :
                                while ( $rooms['data']->have_posts() ) : $rooms['data']->the_post(); ?>
                                    <li class="<?php echo ( $rooms['data']->current_post === 0 ) ? 'active' : '' ?>">
                                        <a href="#tab-<?php echo get_the_ID() ?>" data-toggle="tab"><?php echo intval( $rooms['data']->current_post + 1 ) ?></a>
                                    </li>
                                    <?php
                                endwhile; ?>
                                <li class="ico-next">
                                    <img src="<?php echo esc_url( get_template_directory_uri() . '/v2/images/assets/ico_next.svg' ) ?>" alt="ico-next">
                                </li>
                                <?php
                            endif;
                            ?>
                        ...
                        <div class="tab-content">
                                ...
                                if ( $rooms['data']->have_posts() ) {
                                    while ( $rooms['data']->have_posts() ) {
                                        ...
                                        ?>
                                        <div class="col-xs-12 tab-pane fade<?php echo ( $rooms['data']->current_post === 0) ? ' in active' : '' ?>" id="tab-<?php echo get_the_ID(); ?>">

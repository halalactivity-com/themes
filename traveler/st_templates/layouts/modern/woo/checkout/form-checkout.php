...
<form name="checkout" method="post" class="checkout test woocommerce-checkout st-woo-checkout-form" action="<?php echo esc_url($get_checkout_url); ?>" enctype="multipart/form-data">
